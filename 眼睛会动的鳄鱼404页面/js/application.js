...
(function(e, t) {
	...
	}), v.support.hrefNormalized || v.each(["href", "src", "width", "height"], function(
		e, n) {
...
function(e) {
	e.fn.k = function(t, n) {
		return n == undefined && (n = "38,38,40,40,37,39,37,39,66,65"), this.each(function() {
			var r = [];
			e(this).keydown(function(i) {
				r.push(i.keyCode), r.toString().indexOf(n) >= 0 && (e(this).unbind("keydown", arguments.callee), t(i))
			}, !0)
		})
	}
	...
	function n() {
		t.w = $(window).width(), t.h = $(window).height()
	}
	setTimeout(function() {
		$("p.notice, p.message").fadeTo("slow", 0, function() {
			$(this).remove()
		})
	}, 3e3), $(window).bind("load", function() {
		window.scrollTo(0, 1)
	...
	r.x = parseInt(r.e.css("left")), r.y = parseInt(r.e.css("top"));
	var i = {
		e: $("#smash .hilites")
	};
	i.x = parseInt($("#smash .hilites").css("left")), i.y = parseInt($("#smash .hilites").css("top")), $(document).mousemove(function(e) {
		var n = {
			x: e.pageX / t.w * 2 - 1,
			y: e.pageY / t.h * 2 - 1
		};
		r.moveX = parseInt(n.x * 28 + r.x), r.moveY = parseInt(n.y * 25 + r.y), i.moveX = parseInt(n.x * 7 + i.x), i.moveY = parseInt(n.y * 6 + i.y), r.e.css({
			left: r.moveX,
			top: r.moveY
		}), i.e.css({
			left: i.moveX,
	...
	$(".skull").css("cursor", "pointer").click(function(t) {
		...
		e <= o ? $("#smash").animate({
			...
			bottom: -420
		}, 500, s), e == o && $(this).append('<a href="http://gdzl.la/795z3i" />'), e++
	})
});